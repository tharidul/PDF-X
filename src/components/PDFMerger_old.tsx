...
const PDFMerger: React.FC = () => {
  ...
  // File reordering drag and drop handlers for list
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600">
                ...
                {pdfFiles.length > 1 && (
                  <span className="text-blue-600 ml-2">• Drag files to reorder</span>
                )}
              </p>
            </div>
            <div className="flex items-center space-x-3 mt-4 sm:mt-0">
              ...
              <button
                ...
                className="px-4 py-2 text-red-600 hover:text-red-700 border border-red-300 rounded-lg hover:bg-red-50 transition-all duration-200 flex items-center"
              >
            ...
            <div className="space-y-3">
              {pdfFiles.map((pdf, index) => (
                <div 
                  ...
                  className={`group bg-gray-50 hover:bg-gray-100 border border-gray-200 hover:border-gray-300 rounded-xl p-4 transition-all duration-200 hover:shadow-md cursor-move ${
                    draggedIndex === index ? 'opacity-50 scale-95' : ''
                  } ${
                    dragOverIndex === index && draggedIndex !== index ? 'border-blue-400 bg-blue-50 transform scale-102' : ''
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4 flex-1 min-w-0">
                      <div className="flex flex-col items-center space-y-2">
                        {/* Drag Handle */}
                        <div className="flex flex-col space-y-1 p-2 text-gray-400 hover:text-gray-600 cursor-grab active:cursor-grabbing" title="Drag to reorder">
